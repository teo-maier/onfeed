...
const FormPage = () => {
  ...
  const { formQuestions, question, questionNumber, isBubbleClicked } =
    useSelector<RootState, FormSliceState>((state) => state.form);
  ...
  const handleBubbleClick = () => {
    dispatch(setIsBubbleClicked(true));
  };
  console.log(isBubbleClicked)
